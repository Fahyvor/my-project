/**
 * FingerprintJS Pro React v2.5.0 - Copyright (c) FingerprintJS, Inc, 2023 (https://fingerprint.com)
...
export { Agent, CacheLocation, CacheStub, Cacheable, FpjsClient, FpjsClientOptions, GetOptions, ICache, InMemoryCache, LoadOptions, LocalStorageCache, SessionStorageCache, VisitorData, defaultEndpoint, defaultScriptUrlPattern, defaultTlsEndpoint } from '@fingerprintjs/fingerprintjs-pro-spa';
...
interface GetDataOptions<TExtended extends boolean> extends GetOptions<TExtended> {
    /**
